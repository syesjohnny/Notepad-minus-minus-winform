	...
	public partial class MainForm : Form
	{
		...
		public MainForm(MainFormContainer container)
		{
			...
			if (ConfigManager.IsFirstLaunch)
				ConfigManager.Config.DarkMode = darkNet.UserDefaultAppThemeIsDark;
			// darkNet.UserDefaultAppThemeIsDarkChanged += (_, isSystemDarkTheme) => { ConfigManager.Config.DarkMode = isSystemDarkTheme; ToggleDarkMode(); };
		...
		{
			BottomToolStrip.Visible = !BottomToolStrip.Visible;
		}
